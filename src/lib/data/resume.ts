...
export let DATA = {
	...
	description:
		'Software Engineer turned Entrepreneur. I love building things and helping people. Moderately active on BlueSky.',
	summary:
		'At the end of 2022, I quit my job as a software engineer to go fulltime into building and scaling my own SaaS businesses.',
	avatarUrl: 'https://avatars.githubusercontent.com/u/10413171?v=4',
	skills: [
		'Svelte',
		'Sveltekit',
		'Typescript',
	...
	contact: {
		...
		social: {
			...
			LinkedIn: {
				name: 'LinkedIn',
				url: 'https://www.linkedin.com/in/dwyn/',
				// // icon: Icons.linkedin,
				icon: LinkedinSvg,
				navbar: true,
			...
			X: {
				name: 'BSky',
				url: 'https://bsky.app/profile/wonderfully.black',
				// // icon: Icons.x,
				icon: TwitterSvg,
				navbar: true,
